...
async function main() {
                ...
                create: [
                    {
                        ...
                        imgUrl : "1d7DsiWSDcxRbhzYK2M_XGkRpx1Ays-1l",
                    ...
                    },
                    {
                        ...
                        imgUrl : "1rfoqCc4Qe97b_8h-obZxyS2nIRiAiLt3",
                    ...
                    },
                    {
                        ...
                        imgUrl : "1NjD2vPSMTURDFdnTFxV8R3-iDtlKHHTz",
                        tags: ["Equity Report"],
    ...
    await prisma.author.create({
        data: {
            ...
            role: "Lead Developer",
            linkedin: "https://www.linkedin.com/in/kaikameyama",
            email: "kai@admin.com",
            password,
        },
    });
                ...
                create: [
                    {
                        ...
                        imgUrl : "1KeAsRtfaJnuEK6hyqokaMiklL7mwTAfH",
                        tags: ["Equity Research"],
    ...
    await prisma.author.create({
        data: {
            ...
            name: "Raafay Malik",
            bio: "Bcom @ UBC",
            profileImage: "authors/placeholder.png",
            contact: "raafaym@student.ubc.ca",
            role: "Analyst",
            linkedin: "https://www.linkedin.com/in/raafay-malik-299139329/",
            email: "raffay@admin.com",
            password,
            articles: {
                create: [
                    {
                        id: 5,
                        title: "Procter & Gamble Equity Research Report",
                        slug: "pandg-equity-research",
                        summary: "This report analyzes Procter & Gamble's equity performance, exploring the company's premiumization strategy, margin expansion initiatives, and competitive advantages in the consumer staples industry.",
                        src: "1CzLUhnMDyWM9enuGJxERb4XGhhDi8RS_",
                        imgUrl : "1mYDgx-WeYSpiIKMFNDQJF4bM8nV8jSLM",
                        tags: ["Equity Report"],
